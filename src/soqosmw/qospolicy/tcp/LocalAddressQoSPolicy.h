...
#ifndef SOQOSMW_QOSPOLICY_TCP_LOCALADDRESSQOSPOLICY_H_
#define SOQOSMW_QOSPOLICY_TCP_LOCALADDRESSQOSPOLICY_H_
...
#endif /* SOQOSMW_QOSPOLICY_TCP_LOCALADDRESSQOSPOLICY_H_ */
